...
[![Version](https://img.shields.io/badge/Version-0.37.9--alpha-brightgreen.svg)](CHANGELOG.md)
...
- **Unified Path Segments**: A single `PathSegment` enum (with shared `MovementMeta` + streaming visitors) powers both line and arc moves so stats/iteration stay fast and feed rates stay consistent.
