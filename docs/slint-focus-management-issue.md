...
- **Language**: Rust + Slint
- **Project**: [gcodekit4](https://github.com/thawkins/gcodekit4) - G-code editor for CNC machines
- **Related Files**:
  - `crates/gcodekit4-ui/ui.slint` - Main UI with tabbed views
  - `crates/gcodekit4-ui/ui_panels/gcode_editor.slint` - CustomTextEdit implementation
...
- Project Repository: https://github.com/thawkins/gcodekit4
