...
use gcodekit4::{DeviceConsoleManager, DeviceMessageType};
...
fn test_console_output_format() {
    ...
    assert!(output.contains("GCodeKit4"), "Output should contain 'GCodeKit4'");
...
fn test_console_output_with_connection() {
    ...
    console_manager.add_message(DeviceMessageType::Output, "Connecting to /dev/ttyUSB0 at 115200 baud");
    console_manager.add_message(DeviceMessageType::Success, "Successfully connected to /dev/ttyUSB0 at 115200 baud");
    ...
    assert!(output.contains("Connecting"), "Should contain connection message");
    assert!(output.contains("Successfully connected"), "Should contain success message");
}
