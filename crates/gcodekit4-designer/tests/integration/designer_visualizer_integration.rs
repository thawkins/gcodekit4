use gcodekit4_designer::designer_visualizer_integration::{DesignVisualization, DesignerVisualizerIntegration, MaterialSettings, SimulationState, ToolpathViewSettings, VisualizationBounds};
