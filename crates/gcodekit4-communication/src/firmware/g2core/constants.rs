//! g2core Protocol Constants and Capabilities
//!
//! This module defines all g2core-specific constants, capabilities, status codes,
//! and protocol parameters according to the g2core protocol specification.
//! g2core is the next generation firmware based on TinyG with enhanced capabilities.

// g2core Version Info
/// Minimum supported g2core version
pub const G2CORE_MIN_VERSION: &str = "100.00";

/// g2core standard version string pattern
pub const G2CORE_VERSION_PREFIX: &str = "g2core";

// g2core Capabilities
/// Maximum number of axes supported by g2core
pub const G2CORE_MAX_AXES: u8 = 6;

/// Default buffer size for g2core
pub const G2CORE_DEFAULT_BUFFER_SIZE: usize = 256;

/// g2core block size (maximum command length)
pub const G2CORE_MAX_BLOCK_SIZE: usize = 512;

/// Default serial communication speed (baud rate)
pub const G2CORE_DEFAULT_BAUD_RATE: u32 = 115200;

/// Alternative baud rates supported
pub const G2CORE_ALT_BAUD_RATES: &[u32] = &[9600, 19200, 38400, 57600, 230400];

// g2core Status States
/// Machine is IDLE
...
// g2core Axes (supports A, B, C for rotational axes)
/// X axis code
...
/// A axis code (rotational)
pub const AXIS_A: &str = "a";

/// B axis code (rotational)
pub const AXIS_B: &str = "b";

/// C axis code (rotational)
pub const AXIS_C: &str = "c";

// g2core Status Report Fields
...
// g2core Coordinate Systems (G54-G59)
...
// g2core Advanced Features
/// Enable/disable tool change pause
pub const SETTING_TOOL_CHANGE: &str = "tc";

/// Enable/disable probe function
pub const SETTING_PROBE_ENABLE: &str = "prb";

/// Soft limits enable
pub const SETTING_SOFT_LIMITS: &str = "lim";

// g2core Error Codes (non-exhaustive)
/// Generic error
...
// g2core Alarm Codes (non-exhaustive)
/// Power up or reset
...
// g2core Request/Response Indicators
