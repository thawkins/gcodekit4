...
pub struct GrblControllerState {
    ...
    /// Machine position
    pub machine_position: gcodekit4_core::Position,
    /// Work position
    pub work_position: gcodekit4_core::Position,
    /// Is streaming active
...
impl Default for GrblControllerState {
    fn default() -> Self {
        Self {
            ...
            machine_position: gcodekit4_core::Position::default(),
            work_position: gcodekit4_core::Position::default(),
            is_streaming: false,
            poll_rate_ms: 100,
        }
    }
...
impl ControllerTrait for GrblController {
    ...
    fn register_listener(
        &mut self,
        _listener: Arc<dyn gcodekit4_core::ControllerListener>,
    ) -> gcodekit4_core::ControllerListenerHandle {
        // TODO: Implement listener registration
        gcodekit4_core::ControllerListenerHandle("grbl_listener_1".to_string())
    }
