...
impl TabbedBoxMaker {
    ...
    pub fn generate(&mut self) -> Result<(), String> {
        ...
        self.paths
            .push(self.draw_rectangular_wall(x, h, "FFFF", x_offset, y_offset));
        x_offset += x + spacing;

        // Wall 2: y × h with alternating fingers (bottom/top out, sides in)
        self.paths
            .push(self.draw_rectangular_wall(y, h, "FfFf", x_offset, y_offset));
        y_offset += h + spacing;
        x_offset = 0.0;
        ...
        self.paths
            .push(self.draw_rectangular_wall(x, y, "ffff", x_offset, y_offset));
        x_offset += x + spacing;
