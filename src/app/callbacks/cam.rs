            ...
            dialog.on_generate_box(move || {
                if let Some(d) = dialog_weak_generate.upgrade() {
                    ...
                    let key_divider_type = match key_type_idx {
                        0 => gcodekit4::KeyDividerType::WallsAndFloor,
                        1 => gcodekit4::KeyDividerType::WallsOnly,
                        2 => gcodekit4::KeyDividerType::FloorOnly,
                        3 => gcodekit4::KeyDividerType::None,
                        _ => gcodekit4::KeyDividerType::WallsAndFloor,
                    };
